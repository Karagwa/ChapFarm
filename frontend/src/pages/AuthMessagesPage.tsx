...
const farmers = ['Okello John', 'Apio Sarah', 'Mugisha Robert'];

const AuthMessagesPage = () => {
    ...
    <AuthorityLayout>
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Send messages and alerts to farmers through USSD
        </p>
        ...
        {activeTab === 'Direct Message' && (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Send a message to an individual farmer
            </p>

            {/* Form */}
            <div className="mb-4">
              <label htmlFor="farmer-select" className="text-sm font-medium text-gray-700 block mb-1">
                Select Farmer
              </label>
              <select
                id="farmer-select"
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Keep messages concise. USSD has character limitations.
              </p>
            </div>
...
export default AuthMessagesPage;
